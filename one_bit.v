...
module one_bit(
    ...
    wire wdpg[2:0],wmux[11:0],wdkg[4:0],wfey,wtof,garbage[34:0],wshb,warith;
    ...
    fredGate    mux1(select[1],a,b,garbage[2],wmux[0],garbage[3]),
                ...
                mux3(select[2],wmux[1],wdpg[1],garbage[6],wmux[2],garbage[7]), //to arith mux port 1
                ...
                mux9(select[1],wmux[4],wmux[6],garbage[18],wdkg[1],garbage[19]);
    ...
    fredGate    mux10(wfey,Cin,1'b0,garbage[21],wmux[7],garbage[22]),
                ...
                mux12(wtof,wmux[7],wmux[8],garbage[25],wdkg[2],garbage[26]);        
               
    tofGate     tof1(select[0],select[1],1'b0,garbage[27],garbage[28],wtof);
    
    dkgGate     dkg1(select[1],wdkg[0],wdkg[1],wdkg[2],garbage[29],garbage[30],Cout,wmux[9]);
    
    fredGate    muxArith(select[3],wmux[2],wmux[9],garbage[31],warith,garbage[32]);
    
    shifting_block shb1(1'b1,1'b1,1'b0,1'b0,select[1],select[0],wshb);
    
    fredGate    muxAS(select[4],warith,wshb,garbage[33],y,);
